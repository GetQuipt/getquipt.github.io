...
Quipt's API uses OAuth 1.0a as the primary authorization mechanism, including signing requests and managing access tokens. Start [here](oauth-authorization.html) if you are unfamilar with OAuth 1.0a.
